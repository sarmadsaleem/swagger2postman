  ...
  Swagger2Postman = jsface.Class({
    constructor: function(options) {
      ...
      this.options.includeQueryParams =
        typeof this.options.includeQueryParams == "undefined"
          ? true
          : this.options.includeQueryParams;
    },
    ...
    validate: function(json) {
      if (!json.hasOwnProperty("swagger") || json.swagger !== "2.0") {
        return new ConvertResult(
          "failed",
          "Must contain a swagger field (2.0)"
        );
      }
    ...
    handlePaths: function(json) {
      ...
      for (path in paths) {
        if (paths.hasOwnProperty(path)) {
          ...
          this.logger(
            "Adding path item. path = " + path + "   folder = " + folderName
          );
